                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" action="{{ route('user.store') }}" method="POST" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="description">{{ __('employee.email') }} *</label>
                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="employee_id">{{ __('employee.employee') }} *</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="password_confirmation">{{ __('employee.password_confirm') }} *</label>
                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="role">{{ __('employee.roles') }} *</label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="mdi mdi-file-document"></i>{{ __('employee.add') }}
                                        </button>
