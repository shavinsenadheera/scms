        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('general.breadcrumb.labelstyle.labelstyle_handling') }}</li>
                </ol>
            </nav>
            <div class="col-lg-12 col-md-12 col-sm-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ __('general.breadcrumb.labelstyle.labelstyle_handling') }}</h4>
                        <div class="card-description">
                            <a class="btn btn-icons btn-rounded btn-primary" href="{{ route('labelstyle.create') }}">
                        ...
                        <table class="table table-striped table-hover" id="datatable-1" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th> # </th>
                                <th> {{ __('labelstyle.code') }}</th>
                                <th> {{ __('labelstyle.name') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @if($labelstyles)
                                <span hidden>{{ $i=1 }}</span>
                                @foreach($labelstyles as $data)
                                    <tr>
                                        <td>
