            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">{{ __('general.breadcrumb.supplier_management') }}</a>
                        </li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('supplier.index') }}">{{ __('general.breadcrumb.supplier.supplier_handling') }}</a>
                        </li>
                        <li class="breadcrumb-item active"
                            aria-current="page">{{ __('general.breadcrumb.supplier.supplier_edit') }}</li>
                    </ol>
                </nav>
            </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group{{ $errors->has('name') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                               placeholder="supplier name" value="{{ $supplier->name }}" required>
                                        @error('name')
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group{{ $errors->has('email') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email"
                                               placeholder="supplier email" value="{{ $supplier->email }}" required>
                                        @error('email')
                                        <p class="text-small text-danger">{{ $errors->first() }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group{{ $errors->has('phone_no') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="phone_no" name="phone_no"
                                               placeholder="Supplier phone no" value="{{ $supplier->phone_no }}"
                                               required>
                                        @error('phone_no')
                                        <p class="text-small text-danger">{{ $errors->first() }}</p>
                                        @enderror
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group{{ $errors->has('telephone_no') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="telephone_no" name="telephone_no"
                                               ...
                                               value="{{ $supplier->telephone_no }}" required>
                                        @error('telephone_no')
                                        <p class="text-small text-danger">{{ $errors->first() }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group{{ $errors->has('fax_no') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="fax_no" name="fax_no"
                                               placeholder="Supplier fax number" value="{{ $supplier->fax_no }}"
                                               required>
                                        @error('fax_no')
                                        <p class="text-small text-danger">{{ $errors->first() }}</p>
                                        @enderror
                                ...
                                <div class="col-xl-12 col-lg-12 cl-md-12 col-sm-12">
                                    <div class="form-group{{ $errors->has('address_line_1') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="address_line_1"
                                               name="address_line_1" placeholder="supplier address line 1"
                                               value="{{ $supplier->address_line_1 }}" required>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group{{ $errors->has('address_line_2') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="address_line_2"
                                               name="address_line_2" placeholder="supplier address line 2"
                            ...
                            <div class="form-row">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group{{ $errors->has('city') ? 'has-error' : '' }}">
                                        ...
                                        <select class="form-control js-example-basic-single" name="cities_id"
                                                id="cities_id" data-live-search="true">
                                            @foreach($cities as $data)
                                                <option
                                                    {{ $supplier->cities_id==$data->id ? 'selected' :'' }} value="{{ $data->id }}">{{ $data->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('city')
                                        <p class="text-small text-danger">{{ $errors->first() }}</p>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group{{ $errors->has('zipcode') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="zipcode" name="zipcode"
                                               placeholder="Supplier zip code" value="{{ $supplier->zipcode }}"
                                               required>
                                        @error('zipcode')
                                        <p class="text-small text-danger">{{ $errors->first() }}</p>
                                        @enderror
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group{{ $errors->has('website') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="website" name="website"
                                               placeholder="Supplier website" value="{{ $supplier->website }}" required>
                                        @error('website')
                                        <p class="text-small text-danger">{{ $errors->first() }}</p>
                                        @enderror
                                    </div>
